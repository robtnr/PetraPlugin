...
public class Terminal {
    ...
    public static void run(String configFileLocation) throws AppNameCannotBeExtractedException, NoDeviceFoundException, ADBNotFoundException {
        try {
        ...
        } catch (ApkNotFoundException | IOException |
                NumberOfTrialsExceededException ex) {
