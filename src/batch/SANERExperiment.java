...
class SANERExperiment {
    ...
    public static void main(String[] args) throws IOException, ADBNotFoundException, NoDeviceFoundException {
        ...
        } catch (ApkNotFoundException | FileNotFoundException | NumberOfTrialsExceededException e) {
            e.printStackTrace();
        }
